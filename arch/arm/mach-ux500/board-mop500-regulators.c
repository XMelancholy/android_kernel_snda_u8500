...
static struct regulator_consumer_supply tps61052_vaudio_consumers[] = {
	 ...
	 */
	REGULATOR_SUPPLY("vintdclassint", "ab850x-codec.0"),
};
...
static struct regulator_consumer_supply ab8500_vaux1_consumers[] = {
	...
	REGULATOR_SUPPLY("avdd", "tp_ft5306"),	
	...
	REGULATOR_SUPPLY("Vdd", "2-0039"),
	/* Ambient light sensor device */
	REGULATOR_SUPPLY("Vled", "2-0039"),
...
static struct ab8500_regulator_reg_init ab8500_reg_init[] = {
	 ...
	 */
	INIT_REGULATOR_REGISTER(AB8500_REGUMISC1,              0xfe, 0x14/*0x10*/), // Supply of ULPCLK which clocks LCD pwm backlight.
	/*
	 * VaudioEna                = disabled
	 * VdmicEna                 = disabled
	 * Vamic1Ena                = disabled
