...
void ux500_suspend_dbg_cond(u8 *state, bool *keep_ulp_clk,
		bool *keep_ap_pll);
#else
static inline bool ux500_suspend_ape(void)
{
	return true;
}
static inline void ux500_suspend_dbg_cond(u8 *state, bool *keep_ulp_clk,
		bool *keep_ap_pll) { }
#endif
...
static inline void ux500_suspend_dbg_test_start(int num, int
						down_len,
						int up_len) { }
