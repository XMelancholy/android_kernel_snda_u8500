...
#else
static inline __devinit int ab8500_ext_regulator_init(struct platform_device *pdev)
{
	return 0;
}

static inline __devexit int ab8500_ext_regulator_exit(struct platform_device *pdev)
{
	return 0;
}
#endif
