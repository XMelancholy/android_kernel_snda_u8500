...
/* nb IRQs and nb GIC SHPI registers supported in u8500.
 * The 32 first GIC IRQs are SGI and PPI. SHPI IRQs come next.
 */
#define U8500_GIC_DIST_SPI_NB		128
#define U8500_GIC_DIST_SPI_REGS_NB	(U8500_GIC_DIST_SPI_NB / 32)
#define U8500_GIC_DIST_REGS_NB		(U8500_GIC_DIST_SPI_REGS_NB + 1)
