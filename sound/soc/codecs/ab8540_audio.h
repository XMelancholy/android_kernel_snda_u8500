...
#ifndef AB8540_CODEC_REGISTERS_H
#define AB8540_CODEC_REGISTERS_H

#define AB8540_SUPPORTED_RATE (SNDRV_PCM_RATE_48000)
#define AB8540_SUPPORTED_FMT (SNDRV_PCM_FMTBIT_S16_LE|SNDRV_PCM_FMTBIT_S32_LE)

#define AB8540_IF1_DAI_ID   0
#define AB8540_IF2_DAI_ID   1
#define AB8540_IF3_DAI_ID   2

#define AB8540_VOICE_SUPPORTED_RATE (SNDRV_PCM_RATE_8000  \
				   | SNDRV_PCM_RATE_16000 \
				   | SNDRV_PCM_RATE_48000)

#define AB8540_VOICE_SUPPORTED_FMT (SNDRV_PCM_FMTBIT_S16_LE)

extern struct snd_soc_dai_driver ab8540_codec_dai[];
extern struct snd_soc_codec_driver soc_codec_dev_ab8540;
...
enum ab8540_audio_adcm {
	AB8540_AUDIO_ADCM_NORMAL,
...
{	.iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, \
	...
	.info = snd_soc_info_s, .get = snd_soc_get_smr, \
	.put = snd_soc_put_smr, \
...
{	.iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, \
	...
	.info = snd_soc_info_s, .get = snd_soc_get_smr, \
	.put = snd_soc_put_smr, \
	.private_value =  SOC_SINGLE_VALUE_S2R(reg0, reg1, 1, min, max, \
	invert) }
...
{	.iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, \
	.access = SNDRV_CTL_ELEM_ACCESS_READWRITE, \
	.info = snd_soc_info_s, .get = snd_soc_get_sa, \
	.put = snd_soc_put_sa, \
	.private_value = SOC_MULTIPLE_VALUE_SA(values, ARRAY_SIZE(values), \
	min, max, invert) }

/* AB8540 audio bank (0x0d) register definitions */
...
#define REG_USBCKLOCTRL      0x74
#define REG_EARGAINMICSEL   0x75
#define REG_DIGMULTCONF3    0x76
#define REG_PWMEMICTRL      0x77
#define REG_EPWMACCONF1     0x7A
#define REG_EPWMACCONF2     0x7B
#define REG_EPWMACCONF3     0x7C
#define REG_EPWMACCONF4     0x7D
#define REG_EPWMACCONF5     0x7E
#define REG_EPWMACCONF6     0x7F
#define REG_HFGAIN          0x80
#define REG_VIBGAIN         0x81
#define REG_DA78MIX         0x83
#define REG_DIGIFCONF5      0x84
#define REG_DIGIFCONF6      0x85
#define REG_TXSLOTSEL1      0x86
#define REG_TXSLOTSEL2      0x87
#define REG_TXSLOTSEL3      0x88
#define REG_TXSLOTSEL4      0x89
#define REG_TXSLOTSEL5      0x8A
#define REG_TXSLOTSEL6      0x8B
#define REG_TXSLOTSEL7      0x8C
#define REG_TXSLOTSEL8      0x8D
#define REG_ADSLOTHIZCTRL5  0x8E
#define REG_ADSLOTHIZCTRL6  0x8F
#define REG_RXSLOTCONF      0x91
#define REG_TXPATHENA       0x92
#define REG_DIGMULTCONF4    0x93
#define REG_AUDINTMASK3     0x94
#define REG_AUDINTSOURCE3   0x95
#define REG_TXRXFILTCONF    0x96
#define REG_TXRXSIDETONE1   0x97
#define REG_TXRXSIDETONE2   0x98
#define REG_TXDGAIN1        0x99
#define REG_TXDGAIN2        0x9A
#define REG_TXDGAIN3        0x9B
#define REG_TXDGAIN4        0x9C
#define REG_RXDGAIN         0x9D
#define REG_PNCPCONF        0x9E
#define REG_MIC3CONFIG      0x9F


#define AB8540_FIRST_REG	REG_POWERUP
#define AB8540_LAST_REG		REG_MIC3CONFIG
#define AB8540_CACHEREGNUM	(AB8540_LAST_REG + 1)
...
#define REG_ANACONF4_ENHF			3
#define REG_ANACONF4_ENVIB1         2
...
#define REG_DAPATHCONF_ENDACHF			3
#define REG_DAPATHCONF_ENDACVIB1		2
...
/* REG_DIGMULTCONF2 */
#define REG_DIGMULTCONF2_DATOVIBEN		7
#define REG_DIGMULTCONF2_DATOHFEN		6
#define REG_DIGMULTCONF2_VIBSEL			5
#define REG_DIGMULTCONF2_HFSEL			4
...
/* REG_HSLEARDIGGAIN */
#define REG_HSLEARDIGGAIN_HSLOWLAT		7
#define REG_HSLEARDIGGAIN_HFLOWLAT      6
...
#define REG_EPWM1CONF_EPWM1TOVIB        6
...
#define REG_EPWM2CONF_EPWM2TOHF         6
...
/* REG_USBCKLOCTRL */
#define REG_USBCKLOCTRL_ENCKLOL          7
#define REG_USBCKLOCTRL_ENCKLOR          6
#define REG_USBCKLOCTRL_ENCKLOLDM        5
#define REG_USBCKLOCTRL_ENCKLORDP        4


/* REG_EARGAINMICSEL */
#define REG_EARGAINMICSEL_USBMICSEL   4
#define REG_EARGAINMICSEL_GAIN_MAX    0x8
#define REG_EARGAINMICSEL_GAIN        0

/* REG_DIGMULTCONF3 */
#define REG_DIGMULTCONF3_DA1TOVIB       5
#define REG_DIGMULTCONF3_DA5TOHF        4
#define REG_DIGMULTCONF3_DA6TOVIB       3
#define REG_DIGMULTCONF3_ENPDM1         1
#define REG_DIGMULTCONF3_ENPDM2         0

/* REG_PWMEMICTRL */
#define REG_PWMEMICTRL_DACLOWOBN        5

/* REG_EPWMACCONF1 */
#define REG_EPWMACCONF1_EPWM1ACSEL      7
#define REG_EPWMACCONF1_DCA_MAX         0x64
#define REG_EPWMACCONF1_DCA             0

/* REG_EPWMACCONF2 */
#define REG_EPWMACCONF2_DCB_MAX         0x64
#define REG_EPWMACCONF2_DCB             0

/* REG_EPWMACCONF3 */
#define REG_EPWMACCONF3_FREQ_MAX       0xC8
#define REG_EPWMACCONF3_FREQ           0

/* REG_EPWMACCONF4 */
#define REG_EPWMACCONF4_EPWM2ACSEL      7
#define REG_EPWMACCONF4_DCA_MAX         0x64
#define REG_EPWMACCONF4_DCA             0

/* REG_EPWMACCONF5 */
#define REG_EPWMACCONF5_DCB_MAX         0x64
#define REG_EPWMACCONF5_DCB             0

/* REG_EPWMACCONF6 */
#define REG_EPWMACCONF6_FREQ_MAX       0xC8
#define REG_EPWMACCONF6_FREQ           0

/* REG_HFGAIN  */
#define REG_HFGAIN_HF_MAX             0x1F
#define REG_HFGAIN_HF                 0

/* REG_VIBGAIN */
#define REG_VIBGAIN_GAIN                 0
#define REG_VIBGAIN_GAIN_MAX             0x1F

/* REG_DA78MIX */
#define REG_DA78MIX_MONO                 4
#define REG_DA78MIX_DA7ADDDA1            3
#define REG_DA78MIX_DA8ADDDA2            2
#define REG_DA78MIX_DA7ADDDA3            1
#define REG_DA78MIX_DA8ADDDA4            0

/* REG_DIGIFCONF5 */
#define REG_DIGIFCONF5_ENMASTGEN_IF3    7
#define REG_DIGIFCONF5_IF3MASTER        6
#define REG_DIGIFCONF5_FSYNC3_FREQ1     5
#define REG_DIGIFCONF5_FSYNC3_FREQ0     4
#define REG_DIGIFCONF5_IF3_BITCLK_OSR1  2
#define REG_DIGIFCONF5_IF3_BITCLK_OSR0  1
#define REG_DIGIFCONF5_ENFSBITCLK3      0

/* REG_DIGIFCONF6 */
#define REG_DIGIFCONF6_FSYNC3P          6
#define REG_DIGIFCONF6_BITCLK3P         5
#define REG_DIGIFCONF6_IF3DEL           4
#define REG_DIGIFCONF6_IF3FORMAT1       3
#define REG_DIGIFCONF6_IF3FORMAT0       2
#define REG_DIGIFCONF6_IF3WL1           1
#define REG_DIGIFCONF6_IF3WL0           0

/* REG_TXSLOTSELX */
#define REG_TXSLOTSELX_EVEN_SHIFT       0
#define REG_TXSLOTSELX_ODD_SHIFT        4

/* REG_ADSLOTHIZCTRL5 */
/* REG_ADSLOTHIZCTRL6 */

/* REG_RXSLOTCONF */
#define REG_RXSLOTCONF_SLTORX1          0

/* REG_TXPATHENA */
#define REG_TXPATHENA_ENTX1             7
#define REG_TXPATHENA_ENTX2             6
#define REG_TXPATHENA_ENTX3             5
#define REG_TXPATHENA_ENTX4             4
#define REG_TXPATHENA_ENRX1             3

/* REG_DIGMULTCONF4 */
#define REG_DIGMULTCONF4_DA34_TO_TX34   7
#define REG_DIGMULTCONF4_RX1_TO_HS      6
#define REG_DIGMULTCONF4_RX1_TO_HF      5
#define REG_DIGMULTCONF4_RX1_TO_AD4_SEL 1
#define REG_DIGMULTCONF4_RX1_TO_AD1_SEL 0

/* REG_TXRXFILTCONF */
#define REG_TXRXFILTCONF_RX1HPF         4
#define REG_TXRXFILTCONF_TX34HPF        2
#define REG_TXRXFILTCONF_TX12HPF        0

/* REG_TXRXSIDETONE1 */
#define REG_TXRXSIDETONE1_ST_TX2        2
#define REG_TXRXSIDETONE1_ST_INT_ACT    1
#define REG_TXRXSIDETONE1_ST_EXT_ACT    0

/* REG_TXRXSIDETONE2 */
#define REG_TXRXSIDETONE2_ST_PGA        0
#define REG_TXRXSIDETONE2_ST_PGA_MAX    0x26

/* REG_TXDGAINX */
#define REG_TXDGAINX_TXXGAIN            0
#define REG_TXDGAINX_TXXGAIN_MAX        0x3F

/* REG_RXDGAIN */
#define REG_RXDGAIN_RX1GAIN             0
#define REG_RXDGAIN_RX1GAIN_MAX         0x3F

/* REG_MIC3CONFIG */
#define REG_MIC3CONFIG_ENMIC3           7
#define REG_MIC3CONFIG_MUTEMIC3         6
#define REG_MIC3CONFIG_ENSEMIC3         5
#define REG_MIC3CONFIG_MIC3GAIN         0
#define REG_MIC3CONFIG_MIC3GAIN_MAX	    0x1F
