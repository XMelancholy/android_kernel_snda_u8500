		...
		int *ibat)
{
	...
	case XTAL_TEMP:
		val_reg1 |= EN_BUF | EN_VBIAS_XTAL_TEMP;
		/* Delay might be needed for VBIAS establishment */
	...
	case BAT_TEMP_AND_IBAT:
		val_reg1 |= BTEMP_PULL_UP | EN_ICHAR;
		/* Delay might be needed for pull-up establishment */
		delay_min = 1000; /* Delay in micro seconds */
		delay_max = 10000; /* large range to optimise sleep mode */
		break;
