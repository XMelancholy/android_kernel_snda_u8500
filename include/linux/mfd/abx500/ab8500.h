...
struct ab8500_platform_data {
	...
	struct abx540_modctrl_platform_data *modctrl;
};
...
/* modem dedicated boot services in AB register */
int ab8500_get_modem_power(void);
int ab8500_set_modem_power(int enable_modem_power);
