...
#include "id.h" /* to identify older boards for fixes */
...
ab9540_regulator_reg_init[AB9540_NUM_REGULATOR_REGISTERS] = {
	 ...
	 * SysClkReq5Valid2         = SysClkReq5 controlled
	 * SysClkReq6Valid2         = disabled
	 * SysClkReq7Valid2         = disabled
	 * SysClkReq8Valid2         = disabled
	 */
	INIT_REGULATOR_REGISTER(AB9540_REGUSYSCLKREQVALID2,    0xfe, 0x10),
	/*
	...
	/*
	 * VextSupply1Regu          = HP/LP depending VextSupply1 RequestCtrl
	 * VextSupply2Regu          = HW control
	 * VextSupply3Regu          = HP/LP depending VextSupply3 RequestCtrl
	 * ExtSupply2Bypass         = ExtSupply12LPn ball is 0 when Ena is 0
	 * ExtSupply3Bypass         = ExtSupply3LPn ball is 0 when Ena is 0
	 */
	INIT_REGULATOR_REGISTER(AB9540_EXTSUPPLYREGU,          0xff, 0x2a),
	/*
	 * Vaux1Regu                = force HP
	 * Vaux2Regu                = force on
	 */
	 ...
	 * Vaux3Sel                 = 2.91 V
	 */
	INIT_REGULATOR_REGISTER(AB9540_VRF1VAUX3SEL,           0x37, 0x07),
	/*
