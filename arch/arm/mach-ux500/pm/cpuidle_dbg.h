...
void ux500_ci_dbg_log_post_mortem(int target, int prepare_target,
...
static inline void __init ux500_ci_dbg_init(struct device *dev,
					    struct cstate *cpuidle_cstates,
					    int cpuidle_cstates_len) { }
static inline void ux500_ci_dbg_remove(void) { }
static inline void ux500_ci_dbg_detect_wake_late(ktime_t t_est_wake,
						 int target) { }

static inline void ux500_ci_dbg_log(int ctarget,
				    ktime_t enter_time) { }

static inline void ux500_ci_dbg_log_post_mortem(int target, int prepare_target,
						ktime_t enter_time,
